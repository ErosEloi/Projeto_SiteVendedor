...
namespace ProjetoSiteVendas.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(ProjetoSiteVendasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Department != null ? 
                          ...
                          Problem("Entity set 'ProjetoSiteVendasContext.Department'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjetoSiteVendasContext.Department'  is null.");
            }
            var department = await _context.Department.FindAsync(id);
            if (department != null)
            {
