...
namespace ProjetoSiteVendas.Data
{
    public class SeedingService
    {
        ...
        private ProjetoSiteVendasContext _context;

        public SeedingService(ProjetoSiteVendasContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            if (_context.Department.Any() || _context.Seller.Any() || _context.SaleRecord.Any() ) { return; }
